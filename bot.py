...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_message(kk.id, "**Hello {}!\nWelcome To {}\n\n__Powerd By : @BOTSKINGDOMS __**".format(m.from_user.mention, m.chat.title))
        add_user(kk.id)
...
async def op(_, m :Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [[
            ...
            InlineKeyboardButton("💬 Support", url="https://t.me/BOTSKINGDOMSGROUP")
        ]]
    )
    add_user(m.from_user.id)
    await m.reply_photo("https://ibb.co/sp9F7xfB", caption="**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powered By : @BOTSKINGDOMS __**".format(m.from_user.mention, "https://t.me/BOTSKINGDOMS"), reply_markup=keyboard)
...
async def chk(_, cb : CallbackQuery):
    ...
    add_user(m.from_user.id)
    await cb.edit_text(text="**🦊 Hello {}!\nI'm an auto approve [Admin Join Requests]({}) Bot.\nI can approve users in Groups/Channels.Add me to your chat and promote me to admin with add members permission.\n\n__Powered By : @BOTSKINGDOMS __**".format(cb.from_user.mention, "https://t.me/BOTSKINGDOMS"), reply_markup=keyboard)
